<div class="col-md-12">
    <div class="card card-outline card-info">
        ...
        <?php echo form_open('userdatapkn/insertdata') ?>
        <div class="card-body">
            ...
            <div class="form-group">
                ...
                <input name="tahun_pkn" type="number" min="2000" max="2099" step="1" class="form-control" value="<?= old('tahun_pkn') ?>">
                <p class="text-danger"><?= validation_show_error('tahun_pkn') ?></p>
            </div>
        </div>
