        ...
        <div class="card-header">
            ...
            <div class="card-tools">
                <div class="d-flex">
                    ...
                    <!-- Tombol Tambah -->
                    <a href="<?= base_url('datapkd/input') ?>" class="btn btn-primary btn-xs ms-2">
                ...
                <tr class="search-item">
                    ...
                    <td class="text-center">
                        <div class="btn-group">
                            ...
                            <a href="<?= base_url('datapkd/deletedata/' . $d['nama']) ?>" onclick="return confirm('Yakin Hapus Data..?')" class="btn btn-danger btn-sm btn-flat"><i class="fas fa-trash"></i></a>
                        </div>
                    </td>
                </tr>
            <?php } ?>
