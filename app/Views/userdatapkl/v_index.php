...
<div class="col-md-12">
    <div class="card card-outline card-primary">
        <div class="card-header">
            ...
            <div class="card-tools">
                <div class="d-flex">
                    ...
                    <!-- Tombol Tambah -->
                    <a href="<?= base_url('userdatapkl/input') ?>" class="btn btn-primary btn-xs ms-2">
        ...
        <div class="card-body">
            ...
            <!-- <pre><?php print_r($userdatapkl); ?></pre> -->
                ...
                foreach ($userdatapkl as $d) { ?>
                    <tr class="search-item">
                        ...
                        <td class="text-center">
                            <div class="btn-group">
                                <a href="<?= base_url('userdatapkl/edit/' . $d['nama']) ?>" class="btn btn-warning btn-sm btn-flat">
                                    <i class="fas fa-pencil-alt"></i>
                                </a>
                                <a href="<?= base_url('userdatapkl/deletedata/' . $d['nama']) ?>" 
