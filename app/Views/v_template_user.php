      ...
      <div class="sidebar">
        ...
        <nav class="mt-2">
          <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
            ...
            <li class="nav-item">
              <a href="<?= base_url('DashboardAdmin/DashboardPengurusCabang') ?>" class="nav-link <?= $menu == 'dashboard user' ? 'active' : '' ?>">
            ...
            <li class="nav-item">
              <a href="<?= base_url('userdatamapaba') ?>" class="nav-link <?= $submenu == 'userdatamapaba' ? 'active' : '' ?>">
