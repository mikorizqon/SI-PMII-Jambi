...
<head>
  ...
  <!-- Global CSS -->
  <link rel="stylesheet" href="<?= base_url() ?>assets/css/global-styles.css">
  <!-- SweetAlert2 -->
  ...
  <!-- Di bagian head, setelah SweetAlert2 CSS -->
  <script src="<?= base_url() ?>assets/js/sweet-alert-config.js"></script>
